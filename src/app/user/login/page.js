  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-8">
        <h2 className="text-3xl font-bold text-indigo-700 mb-2 text-center">Sign in to your account</h2>
        ...
        <div className="mt-6 text-sm text-center text-gray-600">
          ...
          <Link href="/user/signup" className="text-indigo-600 hover:underline font-medium">
            Create one
          </Link>
        </div>
      </div>
